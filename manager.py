...
def create_app(config):
  ...
  # logging handler
  # 100M max in this file and backup is 10 if needed
  ...
  # file_log_handler =  RotatingFileHandler(os.path.join(BASE_DIR, "logs/ccvg.log"), maxBytes=1024*1024*100, backupCount=10)
